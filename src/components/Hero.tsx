            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 py-32">
                <div className="text-center">
                    ...
                    >
                        ...
                        <motion.a href="https://drive.google.com/file/d/1L898t08S1TqxqAcmQ_rRICtqH4ax7K9p/view?usp=drivesdk" target="_blank" className="btn-secondary text-sm flex items-center gap-2" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <Download size={14} />
                            Resume
                        </motion.a>
                    </motion.div>
