            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 py-32">
                <div className="text-center">
                    ...
                    >
                        ...
                        <motion.a href="https://drive.google.com/file/d/11eY2yU37aY7d8XX4wEmuRUazGZYc49tN/view?usp=sharing" target="_blank" className="btn-secondary text-sm flex items-center gap-2" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <Download size={14} />
                            Resume
                        </motion.a>
                    </motion.div>
